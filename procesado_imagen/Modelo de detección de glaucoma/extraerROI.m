function [OD_zoom1,OD_zoom2, Validez, centroides_originales]=extraerROI(IgT_cleaned,modo,RGB,SinCaps)%modo=1 si quieres el ROI con capilares, modo=2 si quieres el ROI sin capilares o vacío si solo quieres saber los centroides originales y la validez
margen_zoomed=500;    
...
cc3 = bwconncomp(IgT_cleaned);
    ...
    if cc3.NumObjects==1
        ...
        centroides_originales=[centroideY centroideX];
